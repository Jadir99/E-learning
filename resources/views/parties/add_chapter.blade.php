    ...
    <div class="tab-content">
      <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-7a421d91-36e1-4a1c-94fa-15531761cb81" id="dom-7a421d91-36e1-4a1c-94fa-15531761cb81">
        <form action="{{route('parties.store')}}" method="Post" enctype="multipart/form-data">
          ...
          <div class="mb-3"><label class="form-label">Upload your video</label><input class="form-control" type="file" name="image" value="asasasas" /></div>
          <div class="mb-3"><label class="form-label">Upload your document course</label><input class="form-control" type="file" name="image" value="asasasas" /></div>
          ...
          <div class="card mb-3">
              <div class="card-header">
                <div class="row flex-between-end">
                  <div class="col-auto align-self-center">
                    <h5 class="mb-0" data-anchor="data-anchor">Add devoir if u have one </h5>
                  </div>
                </div>
              </div>
              <div class="card-body bg-light">
